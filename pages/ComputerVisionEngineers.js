...
import {
  ...
  expertsSection,
  aiSection,
} from '../src/constants/computerVisionEngineers'
...
export default function ComputerVisionEngineers() {
  ...
  React.useEffect(() => {
    if (
      ...
      amplitude.getInstance().logEvent('visitedEmployerHomePage-ComputerVision')
      ReactGA.event({
        category: 'ComputerVision',
        action: 'visitedEmployerHomePage-ComputerVision',
      })
