...
import {
  ...
  expertsSection,
  aiSection,
} from '../src/constants/softwareEngineers'
...
export default function SoftwareEngineers() {
  ...
  React.useEffect(() => {
    if (
      ...
      amplitude
        .getInstance()
        .logEvent('visitedEmployerHomePage-SoftwareEngineers')
      ReactGA.event({
        category: 'SoftwareEngineers',
        action: 'visitedEmployerHomePage-SoftwareEngineers',
      })
