...
import {
  ...
  expertsSection,
  aiSection,
} from '../src/constants/NLPEngineers'
import LeaveToLyRise from '../src/components/LeaveToLyRise/LeaveToLyRise'

export default function ComputerVisionEngineers() {
  React.useEffect(() => {
  ...
  React.useEffect(() => {
    if (
      ...
      amplitude.getInstance().logEvent('visitedEmployerHomePage-NLPEngineers')
      ReactGA.event({
        category: 'NLPEngineers',
        action: 'visitedEmployerHomePage-NLPEngineers',
      })
