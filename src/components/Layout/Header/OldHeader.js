...
export default function Header({ isTalent }) {
  ...
  return (
    <header class="py-4 h-[4.25rem]">
      <div
        // style={{ backgroundColor: '#FFF', borderBottom: '2px solid #E2E2E2' }}
        className="flex items-center justify-between gap-4 shadow-[0px_0px_4px_0px_#2957FF] py-3 rounded-[4px] "
      >
        <div
