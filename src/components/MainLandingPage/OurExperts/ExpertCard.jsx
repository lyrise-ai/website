  ...
  return (
    <li className={styles.expertCard}>
      ...
      <figcaption className={styles.card_info}>
        <div className="flex flex-col text-center items-center justify-center gap-0 text-[16px] font-normal font-outfit">
          <h3>{name}</h3>
          <p className="font-[500] text-center text-[17px] font-outfit">
            {title}
          </p>
        </div>
        <ul className="flex items-center justify-center flex-wrap gap-4 mt-4 font-outfit">
