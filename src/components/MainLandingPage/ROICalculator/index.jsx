  ...
  const calculateROI = async () => {
    ...
    try {
      ...
      if (
        ...
        alert(
          'Email notification setup incomplete. Please check console for details.',
        )
        return
      }
        ...
        <div className="flex flex-col items-center justify-center gap-8">
          <div className="flex flex-col items-center justify-center gap-2">
            ...
            <p className="text-center text-[18px] text-[#2C2C2C] font-outfit max-w-2xl">
              Calculate how much time and money you could save with AI
              automation
            </p>
          </div>
                ...
                {results ? (
                  <div className="bg-[#e6f2f8] p-6 rounded-lg">
                    ...
                    <div className="space-y-3 text-[16px] font-outfit">
                      ...
                      <p>
                        <strong>Clients/Year:</strong>{' '}
                        {results.clients.toLocaleString()}
                      </p>
                      <p>
                        <strong>Avg Hours/Client:</strong> {results.hours}
                      </p>
                      <p>
                        <strong>Cost/Hour:</strong> ${results.cost}
                      </p>
